...
export default {
    data: new SlashCommandBuilder()
        .setName('disconnect')
        .setDescription('Disconnect the bot and clear everything'),
    ...
    async execute(interaction, client) {
        ...
        if (!player) {
            return interaction.reply({
                embeds: [{
                    ...
                    description: `${client.config.emojis.error} I'm not connected to a voice channel!`
                }],
        ...
        await interaction.editReply({
            embeds: [{
                ...
                description: `${client.config.emojis.success} Disconnected from <#${channelId}> and cleared all data`
            }]
        });
    }
};

...
Usage: node scripts/auto-select-lavalink.mjs [START_COMMAND] [OPTIONS]
...
Examples:
  node scripts/auto-select-lavalink.mjs                       # Auto-pick lowest ping
  node scripts/auto-select-lavalink.mjs --choose              # Choose from top 5
  node scripts/auto-select-lavalink.mjs "pm2 restart bot" -c  # Choose + PM2
  node scripts/auto-select-lavalink.mjs --dry-run             # Test only
  node scripts/auto-select-lavalink.mjs --choose --dry-run    # Choose but don't apply
`);
  process.exit(0);
}
